...
<body>
	...
	<div class="docDetailMainArea">
						...
						<td style="padding: 5px; border: 1px solid black; height: 25px; text-align: left; color: rgb(0, 0, 0); font-size: 14px; vertical-align: middle; background-color: rgb(255, 255, 255);">
							<span style="font-weight: normal;">
								<span contenteditable="false" data-cid="5" data-dsl="{{period}}" data-wrapper="" style="" data-value="" data-autotype="">
									...
									<input id="endDate" name="endDate" type="date" readonly>
								</span> &nbsp;
							</span> &nbsp;
							<b>사용일수 : </b>
							<span contenteditable="false">
								<input class="fix_input" id="vacUseDays" name="vacUseDays" style="width: 15%" readonly>
							</span>일
						</td>
					</tr>
					<tr>
		...
		<div class="docDetailBtnsArea">
			...
			<button class="commonButton1 requesstList_btn docDetailBtn" onclick="location.href='requestMain.do'" type="button">목록으로</button> <br>
		</div>
 	</div>
