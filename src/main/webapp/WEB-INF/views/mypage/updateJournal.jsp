...
<body>
    ...
    <div class="main_section">
        <form action="journalUpdate" method="post">
            <div id="main_journal_container">
                ...
                <div id="main_content">
                    <div id="main_journal">
                        ...
                        <textarea id="main_journal_content" name="content">${ journal.content }</textarea>
                    </div>
                    <div id="side_note">
                        <div id="side_note_title"><span>비고</span></div>
                        <textarea id="side_note_content" name="sideNote">${ journal.sideNote }</textarea>
                    </div>
                    <div id="uniqueness">
                        <div id="uniqueness_title"><span>특이사항 / 건의사항</span></div>
                        <textarea id="uniqueness_content" name="uniqueness">${ journal.uniqueness }</textarea>
                    </div>
                </div>
            </div>
